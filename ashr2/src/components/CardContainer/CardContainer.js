      ...
      <div className="card-group vgr-cards">
        <div className="card">
          ...
          <div className="card-body">
            ...
            <a href="github.com" className="btn btn-outline-primary">Primary</a>
          </div>
        </div>
        <div className="card">
          <div className="card-img-body">
